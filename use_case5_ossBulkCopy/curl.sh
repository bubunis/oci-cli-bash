...
function oci-curl {
	...
	local tenancyId="ocid1.tenancy.oc1..aaaaaaaaouminldguaddw4th2rysvt2wezzx2nscn6snhkrc72dn6wjs27gq";
    #	local authUserId="ocid1.user.oc1..aaaaaaaabx62rmtndpf4qdxuw72jo2wdldolf3bvonikqqb7bgwqrttgpkma";
	local authUserId="ocid1.user.oc1..aaaaaaaawnxqunzbznobxubbt3uujw3fokhtq5j5yro42uekfeegvvvcqieq"
	local keyFingerprint="3e:ac:ab:da:22:ab:b7:99:66:c7:8c:64:ca:a3:32:23";
	local privateKeyPath="/root/.oci/oci_api_key.pem";
